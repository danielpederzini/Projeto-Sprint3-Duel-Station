...
function show_cards() {
    ...
    if ((deck_number == 1001 && player_lifepoints <= 200) ||
        ...
        (deck_number == 1005 && player_lifepoints <= 1000) ||
        (last_whisper_match)) {
...
function set_attack() {
    ...
    var card_attacks = [
        ...
        750 + round * 250, // Slifer, The Sky Dragon
        1000 + Math.round(player_lifepoints * 0.5), // Obelisk, The Tormentor
        1000 + Math.round(enemy_lifepoints * 0.5), // The Winged Dragon of Rá

        6000 // Holakthy, The Creator of Light
    ];
...
function sea_healing() {
    ...
    var life_bonus = parseInt(Math.random() * (1000 - 499) + 500);
...
function the_awakening() {
    ...
    var awakening = parseInt(Math.random() * 4 + 1) == 4 && deck_number == 1005;
...
function attack() {
    ...
    if (card_attack > enemy_card_attack) {
        ...
        if (player_number == 1005) {
            player_lifepoints += Math.round(attack_difference * 0.10);
        }

    }

    else if (player_number == 1002) {
        player_lifepoints -= Math.round(attack_difference * 0.85);
    }
